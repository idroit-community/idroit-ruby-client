...
describe 'SettingsApi' do
  ...
  # unit tests for settings_controller_find_all
  # Get all admins
  # @param [Hash] opts the optional parameters
  # @return [SettingListResponseDto]
  describe 'settings_controller_find_all test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for settings_controller_find_one
  # Get a specific admin
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [SettingResponseDto]
  describe 'settings_controller_find_one test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
